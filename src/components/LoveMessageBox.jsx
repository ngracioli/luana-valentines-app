...
function LoveMessageBox() {
    const phrases = [
        ...
        "Eu te amo de um jeito que nem sei explicar.",
        "Só de te olhar, meu coração sorri.",
        "Eu me apaixono mais por você a cada dia.",
        "Com você, tudo faz sentido.",
        "Você é o melhor detalhe da minha vida.",
        "Tudo fica melhor quando estou com você.",
        "Você é o motivo do meu sorriso.",
        "Seu amor me faz ser melhor.",
        "A vida ficou mais linda depois que você chegou.",
    ...
    return (
        ...
        >
            <h2 className="text-3xl font-bold text-pink-500 mb-8 flex items-center justify-center gap-2 flex-wrap">
                Minha mensagem de amor para você{" "}
                <span className="inline-block">💖</span>
            </h2>
            <div className="bg-pink-50 p-6 rounded-2xl text-pink-400 border-pink-200 mb-8 shadow-sm border flex items-center justify-center min-h-[80px]">
                <p
            ...
            <button
                onClick={nextPhrase}
                className="bg-pink-500 hover:bg-pink-600 text-white px-8 py-3 rounded-full font-semibold text-lg shadow transition duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-pink-300"
            >
                Mostrar outra
            </button>
